...
class GetCombatBackgroundDataUseCase @Inject constructor(private val superHeroRepository: SuperHeroRepository) {

    operator fun invoke():List<Background>{
        return superHeroRepository.getCombatBackgroundData()
    }
}